...
\begin{table}[htbp]
    \centering
    \caption{Specifications of the University of Duisburg-Essen optical engine.}
...
\begin{enumerate}
    ...
    \item \textbf{Scale range:} The bore (86 mm) and smallest features (valve gaps) differ by two orders of magnitude.
\end{enumerate}
...
\begin{itemize}
    \item \textbf{Base grid:} 256 cells across the bore diameter (cell size $\approx$ 0.34 mm)
...
\begin{itemize}
    \item The University of Duisburg-Essen optical engine provides a well-characterized research platform with extensive experimental data for validation.
