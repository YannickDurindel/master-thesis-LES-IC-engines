...
\begin{itemize}
    ...
    \item \textbf{Momentum focus:} The current work addresses momentum transfer only. Extension to thermal boundary layers is needed for heat flux predictions.
...
\begin{enumerate}
    ...
    \item \textbf{Thermal extension:} Develop a corresponding thermal wall treatment for heat flux predictions, which are critical for engine efficiency and emissions.
\end{enumerate}
